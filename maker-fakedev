...
let handler = async (m, { conn, text, usedPrefix, command }) => {
    if (!text) {
        return m.reply(`┌˚₊ ๑│ ғ ᴀ ᴋ ᴇ  ᴅ ᴇ ᴠ │๑˚₊ ⚠️\n┇ \n│ ❌ *Format salah!*\n│ \n│ 📌 *Cara pakai:*\n│ ${usedPrefix + command} <nama>\n│ \n│ 💡 *Tips:* _Reply foto/gambar jika ingin custom PP,_\n│ _jika tidak akan menggunakan PP WhatsApp-mu._\n┇ \n└˚₊ ๑ ────────────── ๑˚₊\n> © ERINE-AI`)
    }
    ...
    try {
        ...
        const apiUrl = `https://restapi.jagoanproject.web.id/api/maker/fakedev?name=${encodeURIComponent(text)}&image=${encodeURIComponent(imageUrl)}`
        ...
        console.error('[FAKEDEV ERROR]', error)
        await m.react('❌')
...
handler.tags = ['maker']
handler.command = /^(fakedev|devfake)$/i
handler.limit = true
